...
//     [detailDict setObject:[NSString stringWithFormat:@"第%ld周",(long)comps2.week] forKey:@"Weekday"];
...
- (void)drawRect:(CGRect)rect {
    ...
    for (int i =0; i<[weekdays count]; i++) {
        ...
        [weekdayValue drawInRect:CGRectMake(i*(kVRGCalendarViewDayWidth+2), 40, kVRGCalendarViewDayWidth+2, 20) withAttributes:attribute];
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        [date drawInRect:CGRectMake(targetX-9, targetY, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withAttributes:attribute1];
        ...
        [lunarDate drawInRect:CGRectMake(targetX+11, targetY+8, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withAttributes:attribute2];
        ...
        NSDictionary *attribute3 = @{NSFontAttributeName:[UIFont fontWithName:@"HelveticaNeue" size:8], NSParagraphStyleAttributeName:paragraphStyle};
        
        [holiday drawInRect:CGRectMake(targetX, targetY+22, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight) withAttributes:attribute3];
