...
@implementation XLSegmentedControl
...
- (void)commonInit {
    self.scrollView = [[XLScrollView alloc] init];
...
- (void)updateSegmentsRects {
    ...
    } else if (self.type == SegmentedControlTypeTextImages && SegmentedControlSegmentWidthStyleDynamic) {
        NSMutableArray *mutableSegmentWidths = [NSMutableArray array];
